...
**Sample answer**: "Term2 L2 appends X@i to S1,S2,S3, then crashes pre-commit. Term3 L3 (without X@i) is elected by S3,S4,S5. If L3 could commit X@i, then crashes, term4 L4 lacking X@i could be elected; now X@i can be overwritten—violating safety. Hence only current-term entries can advance commitIndex; earlier entries commit indirectly."
